...
function updateAccountMenu() {
	...
	if (!el) return;
	const s = `font-family:'DM Sans',sans-serif;font-size:.78rem;font-weight:500;display:block;width:100%;text-align:left;padding:10px 18px;border:none;cursor:pointer;background:none;color:rgba(248,245,238,.6);transition:background .2s;`;
